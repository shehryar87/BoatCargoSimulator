...
public class PassengerDrop : MonoBehaviour {

	public GameObject childComponent;
	public GameObject mainCamera;
	public GameObject camInside;
	public GameObject stopText;
	public GameObject passengerOn;
	public GameObject[] passengerOff;
	public int levelNo;
	...
	IEnumerator LeveLCompleteRotation(){
		...
		mainCamera.GetComponent<RCCCarCamera>().height = 3.0f;
		...
		yield return new WaitForSeconds (1.9f);
		passengerOff[0].SetActive(false);
		passengerOff[1].SetActive(false);
		passengerOff[2].SetActive(false);
		passengerOn.SetActive(true);
